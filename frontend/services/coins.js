...
const getFactoryCoinAddressContract = () => {
    if (typeof window !== "undefined") return process.env.NEXT_PUBLIC_FACTORY_COIN_CONTRACT;
    return process.env.FACTORY_COIN_CONTRACT;
}

const factoryCoinContract = new ethers.Contract(
    getFactoryCoinAddressContract(), FACTORY_COIN_ABI, getSigner()
)
